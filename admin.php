        ...
        <div class="admin-layout admin-container">
            ...
            <?php elseif ($section === 'value'): ?>
                <div class="admin-header">
                    <h1>
                        <svg class="header-icon" viewBox="0 0 24 24" fill="currentColor" width="28" height="28">
                            <path d="M12 2L2 7l10 5 10-5-10-5zm0 7.8L5.74 7 12 4.2 18.26 7 12 9.8zM2 12l10 5 10-5-2.27-1.01L12 14.45l-7.73-3.46L2 12zm0 5l10 5 10-5-2.27-1.01L12 19.45l-7.73-3.46L2 17z" />
                        </svg>
                        价值卡片
                    </h1>
                </div>
